...
const OwnerSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://rentease-backend-ysgh.onrender.com/tenent/register", user);
        ...
        <Paper elevation={3} sx={{ padding: 4, marginTop: 5, textAlign: "center" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2, marginTop: 2 }}>
              ...
              <Button variant="outlined" color="primary" fullWidth onClick={() => navigate("/owner")}>
